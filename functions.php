...
add_action('init', 'create_post_type_aboutus');
...
function your_login_redirect( ) {
    return admin_url('edit.php?post_type=project');
}
...
// Create 1 Custom Post type for a Demo, called HTML5-Blank
function create_post_type_aboutus()
{
...
// Create 1 Custom Post type for a Demo, called HTML5-Blank
function create_post_type_process()
{
